...
export async function forgotPassword(email: string): PromiseApiResponse<{ message: string }> {
...
export async function resetPassword(token: string, newPassword: string): PromiseApiResponse<{ message: string }> {
