        ...
        <View style={styles.container}>
          <View style={styles.header}>
            ...
            <View style={styles.searchBox}>
              ...
              <TextInput placeholder="Pesquisar" placeholderTextColor="#9ca3af" style={styles.searchInput} />
            </View>
          ...
          <View style={styles.card}>
            <View style={styles.userRow}>
              ...
              <View>
                ...
                <Text style={styles.role}>{user.email || 'email@exemplo.com'}</Text>
              </View>
            </View>
            ...
            <Image source={require('@/assets/trabalhando.png')} style={styles.cardImage} resizeMode="cover" />
          ...
          <View style={styles.card}>
            <View style={styles.userRow}>
              ...
              <View>
                ...
                <Text style={styles.role}>Full Stack Developer | Node.js & Python</Text>
              </View>
            </View>
